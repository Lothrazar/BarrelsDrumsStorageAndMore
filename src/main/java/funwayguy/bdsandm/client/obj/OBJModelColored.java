...
//
//public class OBJModelColored implements IModel
//{
...
//
//    public OBJModelColored(MaterialLibrary matLib, ResourceLocation modelLocation)
//    {
//        this(matLib, modelLocation, new CustomData());
//    }
//
//    public OBJModelColored(MaterialLibrary matLib, ResourceLocation modelLocation, CustomData customData)
//    {
//        this.matLib = matLib;
...
//            {
//                FMLLog.log.fatal("OBJLoaderColored: Unresolved texture '{}' for obj model '{}'", e.getValue().getTexture().getTextureLocation().getPath(), modelLocation);
...
//        return new OBJBakedModelColored(this, state, format, builder.build());
//    }
//
...
//    {
//        OBJModelColored ret = new OBJModelColored(this.matLib, this.modelLocation, new CustomData(this.customData, customData));
//        return ret;
//    }
//
//    @Override
...
//    {
//        OBJModelColored ret = new OBJModelColored(this.matLib.makeLibWithReplacements(textures), this.modelLocation, this.customData);
//        return ret;
//    }
//
...
//        public OBJModelColored parse() throws IOException
//        {
//            String currentLine = "";
...
//            }
//
//            return new OBJModelColored(this.materialLibrary, this.objFrom);
//        }
//    }
//
...
//    }
//
//    public class OBJBakedModelColored implements IBakedModel
//    {
//        private final OBJModelColored model;
...
//
//        public OBJBakedModelColored(OBJModelColored model, IModelState state, VertexFormat format, ImmutableMap<String, TextureAtlasSprite> textures)
//        {
//            this.model = model;
//            this.state = state;
...
//                builder.setQuadTint(this.model.getMatLib().getMaterialNames().indexOf(f.materialName)); // CUSTOM COLOUR HERE
...
//        // FIXME: merge with getQuads
//        /* @Override
//        public OBJBakedModel handleBlockState(BlockState state)
//        {
...
//        }
//
//        private final LoadingCache<IModelState, OBJBakedModelColored> cache = CacheBuilder.newBuilder().maximumSize(20).build(new CacheLoader<IModelState, OBJBakedModelColored>()
//        {
//            @Override
//            public OBJBakedModelColored load(IModelState state) throws Exception
//            {
//                return new OBJBakedModelColored(model, state, format, textures);
//            }
//        });
//
//        public OBJBakedModelColored getCachedModel(IModelState state)
//        {
//            return cache.getUnchecked(state);
//        }
//
//        public OBJModelColored getModel()
//        {
//            return this.model;
//        }
//
...
//        }
//
//        public OBJBakedModelColored getBakedModel()
//        {
//            return new OBJBakedModelColored(this.model, this.state, this.format, this.textures);
//        }
//
//        @Override
